...
@include('view_admin.footer_buttom');
        ...
        <script src="{{ asset('t_admin/admin1/vendors/scripts/core.js') }}"></script>
        <script src="{{ asset('t_admin/admin1/vendors/scripts/script.min.js') }}"></script>
        <script src="{{ asset('t_admin/admin1/vendors/scripts/process.js') }}"></script>
        <script src="{{ asset('t_admin/admin1/vendors/scripts/layout-settings.js') }}"></script>


        <script src="{{ asset('t_admin/admin1/vendors/scripts/apexcharts.min.js') }}"></script>
        <script src="{{ asset('t_admin/admin1/vendors/scripts/jquery.dataTables.min.js') }}"></script>
        <script src="{{ asset('t_admin/admin1/vendors/scripts/dataTables.bootstrap4.min.js') }}"></script>
        <script src="{{ asset('t_admin/admin1/vendors/scripts/dataTables.responsive.min.js') }}"></script>
        <script src="{{ asset('t_admin/admin1/vendors/scripts/responsive.bootstrap4.min.js') }}"></script>
        <script src="{{ asset('t_admin/admin1/vendors/scripts/dashboard.js') }}"></script>
        <!-- js -->


<script src="{{ asset('t_admin/admin1/src/plugins/cropperjs/dist/cropper.js') }}"></script>
<script>
